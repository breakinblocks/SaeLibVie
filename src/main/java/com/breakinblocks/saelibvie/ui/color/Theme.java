...
public final class Theme {
    ...
    private Theme(Identifier id, Style style, float opacity, Map<ColorToken, Integer> colors, Map<String, Integer> metrics, @Nullable Skin skin) {
        this.id = id;
        this.style = style;
    ...
    public Builder derive(Identifier newId) {
    ...
    public static Theme fromJson(Identifier id, JsonObject json, @Nullable Theme parent) {
