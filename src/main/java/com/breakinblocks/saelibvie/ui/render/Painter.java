...
public final class Painter {
    public static final int Z_CONTENT = 0;
    public static final int Z_FLOATING = 250;
    public static final int Z_OVERLAY = 300;
    public static final int Z_TOOLTIP = 400;
    ...
    private static ResourceLocation skinSprite(UiGraphics g, String key) {
        Skin skin = g.theme().skin();
    ...
    public static void vanillaChest(UiGraphics g, ResourceLocation texture, int x, int y, int rows) {
        int topH = rows * 18 + 17;
