...
public class Image extends Widget {
    ...
    private Image(Supplier<Identifier> texture, boolean sprite) {
        this.texture = texture;
        this.sprite = sprite;
    }

    public static Image sprite(Identifier sprite) {
        return new Image(() -> sprite, true);
    }

    public static Image sprite(Supplier<Identifier> sprite) {
        return new Image(sprite, true);
    }

    public static Image texture(Identifier texture, int u, int v, int w, int h) {
    ...
    public static Image texture(Identifier texture, int u, int v, int w, int h, int textureW, int textureH) {
    ...
    protected void paint(UiGraphics g) {
        Identifier location = texture.get();
