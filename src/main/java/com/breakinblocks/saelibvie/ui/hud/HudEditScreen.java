...
public class HudEditScreen extends SaeScreen {
    private final Map<Identifier, HudRegistry.Placement> staged = new HashMap<>();
    private final Map<Identifier, Boolean> stagedEnabled = new HashMap<>();
    ...
    protected void renderOverlay(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        ...
        graphics.text(font, status, 4, height - 12, 0xFFAAAAAA, true);
    }
}
